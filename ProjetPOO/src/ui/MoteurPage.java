...
public class MoteurPage extends JPanel {

    private InspectionFrame frame;

    public MoteurPage(InspectionFrame frame) {
        this.frame = frame;
    ...
    private JPanel createLeftPanel() {
        ...
        JLabel num = new JLabel("02");
        num.setFont(new Font("SansSerif", Font.BOLD, 48));
        num.setForeground(Color.WHITE);

        JLabel title = new JLabel("MOTEUR");
    ...
    private JPanel createBottomPanel() {
        ...
        JButton suivant = new JButton("Suivant → Eclairage");
